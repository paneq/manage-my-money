...
CREATE TABLE "reports" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "type" varchar(255), "name" varchar(255) NOT NULL, "period_type_int" integer NOT NULL, "period_start" date, "period_end" date, "report_view_type_int" integer NOT NULL, "is_predefined" boolean DEFAULT 'f' NOT NULL, "user_id" integer, "created_at" datetime, "updated_at" datetime, "depth" integer DEFAULT 0, "max_categories_count" integer DEFAULT 0, "category_id" integer, "period_division_int" integer DEFAULT 5, "temporary" boolean DEFAULT 'f' NOT NULL);
